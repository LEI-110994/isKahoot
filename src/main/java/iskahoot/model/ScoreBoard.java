...
public class ScoreBoard implements Serializable {
    ...
    private void calculateTeamScores() {
        for (Player p : players) {
            ...
            if (team == null || team.isEmpty()) team = "No Team";
    ...
    public String getCompactScores() {
        // ... (simplified for brevity, or update similarly if needed)
    ...
    public Player getWinningPlayer() {
        // Deprecated concept in Team mode, but returning top player for compatibility
    ...
    public String getWinningTeam() {
        if (teamScores.isEmpty()) return "No Teams";
